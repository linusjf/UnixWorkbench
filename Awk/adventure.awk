...
close("read x;echo $x") 
if (x=="o") {
  print "The wooden door is shut tight."; 
  cave()
} 
if (x=="l") {
  deadend()
...
if (x=="e") {
  print "You decide to quit. Goodbye!";
  exit
} 
if (sword&&x=="s") {
  print "your sword breaks!";
  sword=0;
  cave()
} 
if (axe&&x=="a") {
...
function cave2() { 
  ...
  if (x=="x") {
    print "You see a pile of rubble";
    rubble=1;
    cave2()
  } 
  if (x=="i") {
...
function niche() { 
  ...
  if (!sword&&!axe) 
    print "(f)ight dwarf" 
  if (sword) 
    print "fight dwarf with (s)word" 
  if (axe) 
    print "fight dwarf with (a)xe" 
  if (coin) 
    print "(o)ffer coin to dwarf" 
  print "e(x)amine area" 
  print "read (i)ntroduction" 
  "read x;echo $x"|getline x 
  close("read x;echo $x") 
  ...
  if (x=="t") {
    print "The dwarf grunts";
    niche()
  } 
  if (x=="f") {
    print "The dwarf kills you";
    exit
  } 
  if (x=="s") {
    print "The dwarf kills you";
  ...
  if (coin&&x=="o") {
    print "The dwarf takes the coin and gives you a n axe!";
    coin=0;
    axe=1;
    niche()
  } 
